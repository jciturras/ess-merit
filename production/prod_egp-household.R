...
#Relación de Empleo jefe hogar
sjmisc::frq(elsoc$m26)

elsoc$semp <- as.factor(elsoc$m26)
...
sjmisc::frq(elsoc$m25) #supervision head of household
elsoc$supvis <- elsoc$m25
